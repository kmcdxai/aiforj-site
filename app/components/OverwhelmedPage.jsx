...
export default function OverwhelmedPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", color: "#2a2f35", background: "#f4f1ec" }}>
      <style>{`
      ...
      {step !== "landing" && (
        <div style={{ position:"fixed", top:0, left:0, right:0, height:3, background:"rgba(123,107,154,0.1)", zIndex:50 }}>
      ...
      <header style={{ padding:"16px 20px", display:"flex", justifyContent:"space-between", alignItems:"center", position:"relative", zIndex:10 }}>
        <a href="/" style={{ textDecoration:"none", display:"flex", alignItems:"baseline", gap:2 }}>
          <span style={{ fontFamily:"'Newsreader', serif", fontSize:19, color:"rgba(42,47,53,0.4)" }}>AI</span>
          <span style={{ fontFamily:"'Newsreader', serif", fontSize:19, color:ac }}>Forj</span>
        </a>
        {step !== "landing" && step !== "close" && (
          <span style={{ fontSize:11, color:"rgba(42,47,53,0.25)", fontVariantNumeric:"tabular-nums" }}>{mins}:{(elapsed%60).toString().padStart(2,"0")}</span>
        )}
      </header>
      ...
      <main style={{ maxWidth:540, margin:"0 auto", padding:"0 20px 80px", position:"relative", zIndex:5 }}>
        ...
        {step === "landing" && (
          <div key={fk} style={{ animation:"fadeUp 1s ease", paddingTop:"10vh" }}>
            ...
            <p style={{ fontSize:15, lineHeight:1.9, color:"#7a7a80", marginBottom:20 }}>The to-do list has a to-do list. There's no visible starting point. You feel paralyzed, panicky, numb, or all three at once.</p>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:8, marginBottom:36 }}>
              {[{n:"1",l:"Check",d:"Measure your current overload level"},{n:"2",l:"Regulate",d:"Extended exhale breathing — 4-2-8 pattern"},{n:"3",l:"Externalize",d:"Brain dump everything onto the screen"},{n:"4",l:"Triage",d:"Sort chaos into today / this week / not mine"},{n:"5",l:"Minimum Viable Day",d:"If today is survival mode, what are the bare minimum 3 things?"},{n:"6",l:"Accept + Permit",d:"Radical acceptance + give yourself permission"},{n:"7",l:"One Action",d:"The smallest possible next move"}].map(s => (
                <div key={s.n} style={{ display:"flex", gap:12, alignItems:"flex-start", padding:"10px 14px", background:"rgba(255,255,255,0.5)", borderRadius:10, border:"1px solid #e0dbd3" }}>
                  ...
                  <div><span style={{ fontSize:13, fontWeight:600 }}>{s.l}</span><p style={{ fontSize:11, color:"#7a7a80", marginTop:1, lineHeight:1.4 }}>{s.d}</p></div>
                </div>
              ))}
            </div>

            <div style={{ textAlign:"center" }}><Btn onClick={() => go("breathe")}>Let's slow it down</Btn></div>
            <p style={{ fontSize:10, color:"#7a7a80", opacity:0.4, marginTop:32, lineHeight:1.7, textAlign:"center" }}>Built by a Board Certified PMHNP. Nothing stored or sent.</p>
          </div>
        )}
        ...
        {step === "breathe" && (
          <div key={fk} style={{ animation:"fadeUp 0.8s ease", paddingTop:"6vh" }}>
            ...
            <p style={{ fontSize:14, lineHeight:1.8, color:"#7a7a80", marginBottom:6 }}>Overwhelm triggers the same fight-or-flight cascade as a physical threat. Shallow breathing, tight chest, narrowed thinking. This 4-2-8 pattern — exhale double the inhale — activates your parasympathetic nervous system through the vagus nerve. Three cycles is enough to shift the balance.</p>
            ...
            <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:20, padding:"12px 0" }}>
              {bPhase === "ready" ? (
                ...
                <div style={{ textAlign:"center" }}>
                  ...
                  <p style={{ fontSize:13, color:"#7a7a80", marginTop:6 }}>Your prefrontal cortex is coming back.</p>
                </div>
              ) : (
                <>
                  ...
                  <span style={{ fontSize:11, color:"#7a7a80", letterSpacing:2 }}>{Math.min(bCycle+1,3)} / 3</span>
                </>
              )}
            </div>
        ...
        {step === "dump" && (
          <div key={fk} style={{ animation:"fadeUp 0.8s ease", paddingTop:"6vh" }}>
            ...
            <p style={{ fontSize:14, lineHeight:1.8, color:"#7a7a80", marginBottom:6 }}>Your brain is recycling the same worries because it's terrified of dropping one. The solution: move EVERYTHING from internal storage to external storage. Every task, worry, obligation, "I should," half-finished thought, unnamed dread. Don't organize. Don't prioritize. Don't judge. Just dump.</p>
            ...
            <div style={{ padding:16, background:"rgba(123,107,154,0.04)", borderRadius:12, border:"1px solid rgba(123,107,154,0.08)", marginTop:16 }}>
              <p style={{ fontSize:12, color:"#7a7a80", lineHeight:1.7 }}><strong style={{ color:ac }}>Pennebaker's research (UT Austin):</strong> Externalizing worries reduces their emotional charge by up to 20% and frees working memory capacity. Your brain can stop holding items once it knows they've been "saved" somewhere external.</p>
            </div>
            <p style={{ fontSize:10, color:"#7a7a80", opacity:0.3, marginTop:12, textAlign:"center" }}>Nothing stored or sent anywhere.</p>
        ...
        {step === "triage" && (
          <div key={fk} style={{ animation:"fadeUp 0.8s ease", paddingTop:"6vh" }}>
            ...
            <p style={{ fontSize:14, lineHeight:1.8, color:"#7a7a80", marginBottom:6 }}>Overwhelm collapses time — everything feels like it needs to happen NOW. But your brain is lying. Look at your dump and sort into three containers. Be ruthless: "today" means real consequences if not done in the next 12 hours. Most things will go in "this week" or "not mine." That's the point.</p>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:18, marginTop:16 }}>
              <div>
                <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:6 }}>
                  ...
                  <span style={{ fontSize:11, color:"#7a7a80", opacity:0.5 }}>— actual consequences if not</span>
                </div>
              ...
              <div>
                <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:6 }}>
                  ...
                  <span style={{ fontSize:11, color:"#7a7a80", opacity:0.5 }}>— important but not today</span>
                </div>
              ...
              <div>
                <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:6 }}>
                  ...
                  <span style={{ fontSize:11, color:"#7a7a80", opacity:0.5 }}>— future, hypothetical, or someone else's</span>
                </div>
        ...
        {step === "mvd" && (
          <div key={fk} style={{ animation:"fadeUp 0.8s ease", paddingTop:"6vh" }}>
            ...
            <p style={{ fontSize:14, lineHeight:1.8, color:"#7a7a80", marginBottom:6 }}>This concept comes from software development: a Minimum Viable Product is the simplest version that still works. Your Minimum Viable Day is: if today is a survival day — not a great day, not a productive day, just a "I made it through" day — what are the absolute bare minimum 3 things that need to happen?</p>
            ...
            <div style={{ padding:16, background:"rgba(123,107,154,0.04)", borderRadius:12, marginTop:16 }}>
              <p style={{ fontSize:12, color:"#7a7a80", lineHeight:1.7 }}><strong style={{ color:ac }}>Why 3?</strong> Research on decision fatigue shows that limiting choices to 3 reduces cognitive load while maintaining a sense of control. If you complete these 3 things, today was not a failure — no matter what else happens. That reframe alone reduces overwhelm.</p>
            </div>
        ...
        {step === "accept" && (
          <div key={fk} style={{ animation:"fadeUp 0.8s ease", paddingTop:"6vh" }}>
            ...
            <p style={{ fontSize:14, lineHeight:1.8, color:"#7a7a80", marginBottom:20 }}>Two exercises from DBT (Dialectical Behavior Therapy). First: radical acceptance — naming what you can't change so you stop spending energy fighting it. Second: permission — explicitly giving yourself the thing you've been denying.</p>
          ...
          <div key={fk} style={{ animation:"fadeUp 0.8s ease", paddingTop:"6vh" }}>
            ...
            <div style={{ marginBottom:16 }}>
              ...
              <div style={{ display:"flex", justifyContent:"space-between", marginBottom:4 }}>
                <span style={{ fontSize:12, color:"#7a7a80" }}>Manageable</span>
                ...
                <span style={{ fontSize:12, color:"#7a7a80" }}>Drowning</span>
              </div>
        ...
        {step === "close" && (
          <div key={fk} style={{ animation:"fadeUp 1s ease", paddingTop:"6vh" }}>
            ...
            <p style={{ fontSize:15, lineHeight:1.8, color:"#7a7a80", marginBottom:24 }}>That's the entire mechanism of overwhelm recovery. You regulated your nervous system, externalized the chaos, triaged what's real, defined your minimum viable day, accepted what you can't control, gave yourself permission, and committed to one concrete action.</p>
            ...
            <div style={{ padding:22, background:"rgba(255,255,255,0.6)", borderRadius:16, border:"1px solid #e0dbd3", marginBottom:20 }}>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:12 }}>
                <div><p style={{ fontSize:10, color:"#7a7a80", textTransform:"uppercase", letterSpacing:1 }}>Minimum Viable Day</p><p style={{ fontSize:14, lineHeight:1.6 }}>1. {mvd1}{mvd2 ? ` · 2. ${mvd2}` : ""}{mvd3 ? ` · 3. ${mvd3}` : ""}</p></div>
                <div><p style={{ fontSize:10, color:"#7a7a80", textTransform:"uppercase", letterSpacing:1 }}>Accepted</p><p style={{ fontSize:13, fontStyle:"italic" }}>"{acceptance}"</p></div>
                <div><p style={{ fontSize:10, color:"#7a7a80", textTransform:"uppercase", letterSpacing:1 }}>Permission granted</p><p style={{ fontSize:13, fontStyle:"italic" }}>"{permission}"</p></div>
                <div><p style={{ fontSize:10, color:"#7a7a80", textTransform:"uppercase", letterSpacing:1 }}>Next action</p><p style={{ fontSize:15, color:ac, fontWeight:600 }}>"{oneAction}"</p></div>
                <div><p style={{ fontSize:10, color:"#7a7a80", textTransform:"uppercase", letterSpacing:1 }}>Session</p><p style={{ fontSize:13 }}>{mins} min · {lineCount} items externalized · 4-2-8 breathing · CBT triage · DBT acceptance</p></div>
              </div>
            </div>
            ...
            <div style={{ padding:20, background:"rgba(123,107,154,0.04)", borderRadius:14, marginBottom:20 }}>
              ...
              <p style={{ fontSize:14, color:"#7a7a80", lineHeight:1.8 }}>Do NOT look at the full list again yet. Complete the one action first. Then pick the next smallest thing from your MVD. If overwhelm returns, come back here. This protocol works every time because it's built on how your brain actually processes load — not on willpower or motivation.</p>
            </div>

            <div style={{ padding:16, background:"rgba(123,107,154,0.04)", borderRadius:12, marginBottom:20 }}>
              <p style={{ fontSize:14, color:"#7a7a80", lineHeight:1.7 }}>Bookmark <strong style={{ color:ac }}>aiforj.com/overwhelmed</strong> — free, private, always here. Send to someone who's drowning in their to-do list.</p>
            </div>

            <div style={{ textAlign:"center", marginBottom:24 }}>
              <p style={{ fontSize:14, color:"#7a7a80", marginBottom:14, lineHeight:1.7 }}>If overwhelm is recurring, Forj can help build longer-term strategies.</p>
            ...
            <div style={{ padding:16, borderRadius:12, border:"1px solid #e0dbd3", textAlign:"center" }}>
              <p style={{ fontSize:11, color:"#7a7a80", opacity:0.4, lineHeight:1.8 }}>If you're in crisis: <strong>988 Lifeline</strong> — call or text 988 | <strong>Crisis Text Line</strong> — text HOME to 741741</p>
            </div>
            <p style={{ textAlign:"center", fontSize:10, color:"#7a7a80", opacity:0.25, marginTop:24 }}>Built by a Board Certified PMHNP-BC — Caring for the Whole Human<br/>© 2026 AIForj.com</p>
          </div>
        )}
      </main>
    </div>
