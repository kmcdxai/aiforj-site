        ...
        {step === "close" && (
          <div key={fk} style={{ animation:"fadeUp 1s ease", paddingTop:"6vh" }}>
            ...
            <div style={{ textAlign:"center", marginBottom:24 }}>
              <p style={{ fontSize:14, color:"#5a5a62", marginBottom:14, lineHeight:1.7 }}>If overwhelm is recurring, Forj can help build longer-term strategies.</p>
            ...
            <div style={{ padding:16, borderRadius:12, border:"1px solid #e0dbd3", textAlign:"center" }}>
              <p style={{ fontSize:11, color:"#5a5a62", opacity:0.4, lineHeight:1.8 }}>If you're in crisis: <strong>988 Lifeline</strong> — call or text 988 | <strong>Crisis Text Line</strong> — text HOME to 741741</p>
            </div>
            <p style={{ textAlign:"center", fontSize:10, color:"#5a5a62", opacity:0.25, marginTop:24 }}>Built by a Board Certified PMHNP-BC — Caring for the Whole Human<br/>© 2026 AIForj.com</p>
          </div>
        )}
      </main>
    </div>
