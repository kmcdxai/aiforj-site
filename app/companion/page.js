...
export const metadata = buildContentPageMetadata({
  ...
  description: `Free voice-based AI therapeutic companion built and clinically informed by Kevin, a clinician in psychiatric NP training. ${FORJ_MODALITY_COUNT} evidence-based therapeutic modalities. Premium upgrades are available for deeper support.`,
  path: '/companion',
