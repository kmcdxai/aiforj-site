...
export const metadata = {
  ...
  description: "Free provider finder tool. Search by insurance, specialty, and location for psychiatrists, psychologists, psychiatric NPs, and therapists. Get a ready-to-use calling script, questions to ask, and affordable options if you're uninsured. 100% private. Built by Kevin Cooke, PMHNP-BC.",
  alternates: {
