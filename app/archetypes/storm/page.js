...
const metadata = buildContentPageMetadata({
  ...
  description: 'Discover what it means to be The Storm. Understand your stress response, thinking patterns, and evidence-framed techniques matched to this archetype. Free guide from AIForj.',
