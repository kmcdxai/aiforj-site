const metadata = {
  ...
  description: 'Discover what it means to be The Empath. Understand your stress response, thinking patterns, and evidence-based techniques matched to this archetype. Free guide by a Board-Certified Healthcare Professional.',
};
  ...
  return (
    <main className="container">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "The Empath: Understanding the Sensitive Responder",
