const metadata = {
  ...
  description: 'Discover what it means to be The Phoenix. Understand your stress response, thinking patterns, and evidence-based techniques matched to this archetype. Free guide by a Board-Certified Healthcare Professional.',
};
