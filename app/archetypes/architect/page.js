const metadata = {
  ...
  description: 'Discover what it means to be The Architect. Understand your stress response, thinking patterns, and evidence-based techniques matched to this archetype. Free guide by Kevin Cooke, PMHNP-BC.',
};
