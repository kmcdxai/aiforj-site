...
export const metadata = {
  title: 'Manage Your Subscription & Billing | Forj',
  description: 'Manage your Forj subscription, cancel renewal, update payment details, and find invoices through Stripe.',
...
export default function BillingPage() {
  return <><main style={{maxWidth:760,margin:'80px auto',padding:'0 24px',fontSize:16,lineHeight:1.8,color:'var(--text-primary)'}}>
    ...
    <section><h2>Other Forj plans</h2><p>The same portal manages subscriptions purchased through AIForj, including existing family, clinician, or organization plans. The plan, price, and renewal dates shown in your checkout and Stripe account apply. One-time gifts do not automatically renew.</p></section>
    <section><h2>Need purchase help?</h2><p>Email <a href="mailto:hello@tredicihealth.com">hello@tredicihealth.com</a> with your receipt reference and checkout email. Do not send card numbers, passwords, private activation links, or health information.</p><p>If a Forj subscription or gift is not right for you, contact us within 14 days of a charge for a refund. This does not limit mandatory consumer rights. Tredici’s Payhip downloads use their <a href="https://tredicihealth.com/purchase-support">separate purchase support page</a>.</p></section>
    <section><h2>Access on another device</h2><p>Use the private activation link saved after your original checkout. If you no longer have it, contact purchase support. Keep it private: it provides access to your purchased features. Do not buy a second subscription just to restore access.</p><p>Forj provides self-guided wellness tools. Purchases do not include clinical care or establish a clinician-patient relationship. <Link href="/what-we-collect">Read the privacy explanation.</Link></p></section>
  </main><SiteFooter/></>;
}
