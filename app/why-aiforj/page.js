...
const NARRATIVE_POINTS = [
  ...
  {
    title: "Solution",
    body: "Tredici provides clinician-informed emotional first aid: fast matching, guided tools, measurable self-reported shifts, and a bridge to human support when the moment crosses the line into crisis or clinical care.",
  },
  {
    title: "Moat",
...
export const metadata = buildContentPageMetadata({
  title: "Why Tredici Exists | Tredici",
  description:
    "The core narrative behind Tredici: why emotional first aid matters, what makes the product defensible, and how trust-compatible growth works.",
  path: "/why-aiforj",
  socialTitle: "Why Tredici Exists",
  socialDescription:
    "The problem, insight, solution, moat, and business model behind Tredici.",
  type: "article",
});

export default function Page() {
  const articleSchema = buildArticleSchema({
    title: "Why Tredici exists",
    description: metadata.description,
    url: "https://aiforj.com/why-aiforj",
    section: "Company narrative",
    about: "Tredici company narrative and product vision",
  });
  const breadcrumbSchema = buildBreadcrumbSchema([
    { name: "Home", item: "https://aiforj.com" },
    { name: "Why Tredici", item: "https://aiforj.com/why-aiforj" },
  ]);
        ...
        <article style={{ display: "grid", gap: 24 }}>
          ...
          >
            ...
            <p style={{ margin: 0, color: "var(--text-secondary)", lineHeight: 1.9 }}>
              Tredici is built around a simple belief: when someone is spiraling,
          ...
          >
            ...
            <p style={{ margin: 0, color: "var(--text-secondary)", lineHeight: 1.85 }}>
              Tredici is building the emotional first-aid layer of the internet:
