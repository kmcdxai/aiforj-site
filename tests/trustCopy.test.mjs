...
const DISALLOWED_COPY = [
  ...
  { pattern: /\btherapeutic companion\b/i, reason: "Use wellness companion; AIForj is not therapy." },
  ...
  { pattern: /\bevidence-based treatment for depression\b/i, reason: "Avoid implying AIForj provides depression treatment." },
  { pattern: /\bstructured, clinical technique\b/i, reason: "Avoid implying AIForj delivers clinical care." },
