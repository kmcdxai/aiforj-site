...
const DISALLOWED_COPY = [
  ...
  { pattern: /\bhealthcare professional tool\b/i, reason: "Avoid over-specific credential claims in page titles." },
  { pattern: /\bby a healthcare professional\b/i, reason: "Avoid over-specific credential claims in page titles." },
  ...
  { pattern: /\btherapeutic companion\b/i, reason: "Use wellness companion; Tredici is not therapy." },
  { pattern: /\btherapeutic techniques\b/i, reason: "Use emotional first-aid or self-guided techniques." },
  { pattern: /\bclinical-grade\b/i, reason: "Avoid implying clinical care delivery." },
  { pattern: /\bstandalone treatment approach\b/i, reason: "Frame self-guided tools as wellness exercises, not care delivery." },
  { pattern: /\bevidence-based treatment for depression\b/i, reason: "Avoid implying Tredici provides depression treatment." },
  { pattern: /\bstructured, clinical technique\b/i, reason: "Avoid implying Tredici delivers clinical care." },
  { pattern: /\bverified provider data\b/i, reason: "Provider search returns registry-listed data; Tredici does not verify providers." },
  ...
  { pattern: /"@type"\s*:\s*"MedicalCondition"/i, reason: "Tredici pages should not use medical schema for wellness self-guided tools." },
];
