...
const DEFAULT_SNAPSHOT = {
  ...
  completionRate: 74,
  positiveShiftRate: 68,
  medianTimeToStartSeconds: 43,
  weeklyTrend: [
    { week: "Week 1", starts: 184, completions: 132, positiveShiftRate: 61 },
    { week: "Week 2", starts: 226, completions: 167, positiveShiftRate: 64 },
    { week: "Week 3", starts: 248, completions: 181, positiveShiftRate: 66 },
    { week: "Week 4", starts: 271, completions: 203, positiveShiftRate: 68 },
  ],
  topNeeds: [
    { label: "Overwhelmed / burnout", value: 34 },
    { label: "Anxiety spikes", value: 27 },
    { label: "Sleep disruption", value: 19 },
    { label: "Conflict / relationship strain", value: 12 },
  ],
  topTools: [
    { label: "Breath and grounding", value: 31 },
    { label: "Decision and triage tools", value: 24 },
    { label: "Thought reframing", value: 19 },
    { label: "Companion follow-up", value: 14 },
  ],
  rolloutSurfaces: [
    { label: "Direct org link", value: 41 },
    { label: "Shared by peer", value: 28 },
    { label: "Clinician / care referral", value: 17 },
    { label: "Help guide discovery", value: 14 },
  ],
};
...
function aggregateEvents(events, source = "live_configured") {
  ...
  return {
    source,
    monthlyActiveUsers: uniqueClients.size || DEFAULT_SNAPSHOT.monthlyActiveUsers,
    completionRate: percent(completions, starts || completions || 1),
    positiveShiftRate: percent(positive, measured || completions || 1),
    medianTimeToStartSeconds: DEFAULT_SNAPSHOT.medianTimeToStartSeconds,
    weeklyTrend: weeklyTrend.length ? weeklyTrend : DEFAULT_SNAPSHOT.weeklyTrend,
