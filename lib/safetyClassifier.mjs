...
export const CRISIS_HANDOFF_TEXT =
  "I hear you, and what you are feeling matters. This is beyond what Tredici can safely help with in chat, and you deserve real human support right now. If you are in the U.S., call or text 988. You can also text HOME to 741741, contact emergency services if there is immediate danger, or reach out to a trusted person who can stay with you. I am going to pause normal chat and keep this focused on getting you supported.";

export const MEDICATION_BOUNDARY_TEXT =
  "Tredici cannot advise on starting, stopping, changing, or dosing medication, and it cannot diagnose you. A prescriber, pharmacist, or urgent care service is the right place for medication decisions, especially if symptoms feel severe or unsafe. I can help you prepare a short list of what to tell a prescriber.";
